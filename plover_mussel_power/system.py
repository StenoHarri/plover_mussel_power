...
DICTIONARIES_ROOT = 'asset:plover_mussel_power:dictionaries'
DEFAULT_DICTIONARIES = ('user_entries.json','Mussel_Power_base_british_generated_31_08_2026.json', 'pseudo_steno.py')
